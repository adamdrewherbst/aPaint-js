...
(function () {
  ...
  function getPointer(event, upperCanvasEl) {
	...
	if(event.type === 'mousedown') {
		console.info('fabric mousedown');
		console.info(event.target);
		console.info(firstFixedAncestor);
...
(function () {
  ...
  extend(fabric.StaticCanvas.prototype, /** @lends fabric.StaticCanvas.prototype */ {
    ...
    addMyListeners: function() {
        ...
        fabric.util.addListener(fabric.window, 'resize', this._onResize);
	},
	...
	removeMyListeners: function() {
        ...
        fabric.util.removeListener(fabric.window, 'resize', this._onResize);
	},
